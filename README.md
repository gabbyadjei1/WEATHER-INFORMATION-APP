...
This application provides real-time weather updates using OpenWeatherMap API  * with a Java Swing graphical user interface.
 ...
 * [2] Morelli, R. & Wade, R. (n.d.). Java, Java, Java - Object-Oriented 
 * [3] M.G.A. (2022, November 20). Java GUI programming: An overview for 
 * [4] Chua, E. H. (n.d.). Java Programming Tutorial: Programming Graphical 

# COMPILATION (No extra dependencies needed for Swing):
